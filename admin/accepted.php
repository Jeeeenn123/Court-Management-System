...
<div class="sidebar">
    ...
    <div class="links">
        ...
        <div class="dropdown-container">
            <a href="accepted.php" class="accepted"><img src="assets/imgs/accept.png" class="icon"><span class="list">Accepted</span></a>
...
<?php
        ...
        if ($result->num_rows > 0) {
            ...
            while($row = $result->fetch_assoc()) {
                ...
                echo "<td>" . date("F j, Y", strtotime($row["accepted_date"])) . "</td>";
                echo "</tr>";
            }
            echo "</table>";
        } else {
