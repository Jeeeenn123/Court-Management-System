...
<div class="sidebar">
    ...
    <a href="users.php" class="users"><img src="assets/imgs/users.png"><span class="list">Users</span></a>
    </div>
    <div class="logoutBtn">
    ...
    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            echo "<tr>
                ...
                <td>".$row['role']."</td>
                <td>
                    <button class='button-accept'><a href='delete_user.php?id=" . $row["users_id"] . "' onclick=\"return confirm('Are you sure you want to delete this user?');\">Delete</a></button>
                </td>
                </tr>";
    }
}
