...
<html lang="en">
      ...
      <div class="fixed top-0 left-0 flex h-screen w-64 flex-col bg-white shadow-lg">
        ...
        <div class="dropdown mb-2">
          ...
          <ul class="dropdown-menu w-100">
            ...
            <li><a class="dropdown-item hover:bg-gray-200" href="denied.php">Denied</a></li>
            <li><a class="dropdown-item  bg-green-200" href="#">Cancelled</a></li>
          </ul>
        </div>
  ...
  if ($result->num_rows > 0) {
      while($row = $result->fetch_assoc()) {
          ...
          echo '<div class="sm:table-cell"><span class="font-semibold">Date Accepted:</span> '.date("m/d/Y", strtotime($row["cancelled_date"])).'</div>';
          echo '</div>'; // row
          echo '</div>'; // card
      }
  } else {
