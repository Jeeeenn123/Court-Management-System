...
// ✅ also fetch users_id now
$user_sql = "SELECT users_id, email, phonenumber, fullname FROM users WHERE username = ?";
...
$user_id = $user_row['users_id'];   // ✅ added
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // ✅ Insert users_id as well
    $sql = "INSERT INTO reservations 
            (users_id, username, fullname, email, phonenumber, court_type, date, time_slot, status, created_at)
            VALUES (?, ?, ?, ?, ?, ?, ?, ?, 'PENDING', NOW())";
